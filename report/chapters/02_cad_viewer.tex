...
%% IMAGE NEEDED: cad_nodes_grillage.png -- 3D view with node spheres + grillage edges + node numbers
\osdagfig{cad_nodes_grillage.png}{The 3D CAD viewer with node markers, the grillage overlay,
and node numbers displayed on top of the plate-girder model.}{fig:cadnodes}

%% IMAGE NEEDED: cad_node_hover.png -- hover tooltip showing a node number under the cursor
\osdagfig{cad_node_hover.png}{Hover tooltip identifying the node nearest the cursor.}{fig:cadhover}
