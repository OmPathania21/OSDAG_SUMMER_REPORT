...
%% IMAGE NEEDED: report_plot_capture.png -- an analysis envelope plot as embedded in the report
\osdagfig{report_plot_capture.png}{A bending-moment envelope plot captured and auto-cropped for
the design report.}{fig:plotcapture}

%% IMAGE NEEDED: plot_zoom_window.png -- the plot view with a rubber-band zoom selection
\osdagfig{plot_zoom_window.png}{The plot zoom-window: dragging a rectangle scales the canvas so
