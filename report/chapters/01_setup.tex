...
%% IMAGE NEEDED: osdagbridge_gui.png -- full OsdagBridge window (input dock, CAD view, output dock, log)
\osdagfig{osdagbridge_gui.png}{The OsdagBridge desktop application, showing the Input Dock,
