...
%% IMAGE NEEDED: toolbar_full.png -- the complete toolbar with all buttons labelled
\osdagfig{toolbar_full.png}{The OsdagBridge toolbar, driving the 3D CAD and plot views.}{fig:toolbar}

%% IMAGE NEEDED: toolbar_labels_toggle.png -- 3D view with node/element/girder labels toggled on
\osdagfig{toolbar_labels_toggle.png}{Node-number, element-number, and girder-label toggles
