...
%% IMAGE NEEDED: report_ch5_checks.png -- a page of the generated report showing Section 5 design-check tables
\osdagfig{report_ch5_checks.png}{A page of the generated design report showing Section~5 design
checks with PASS/FAIL status.}{fig:repchecks}

%% IMAGE NEEDED: report_options_dialog.png -- the report-options dialog with the chapter checklist
\osdagfig{report_options_dialog.png}{The report-options dialog: locked core chapters and
optional chapters, including the new Design Log Window.}{fig:repopts}

%% IMAGE NEEDED: report_ch6_drawings.png -- report Chapter 6 with cross-bracing / end-diaphragm figures
\osdagfig{report_ch6_drawings.png}{Report Chapter~6 drawings: cross-bracing and end-diaphragm
